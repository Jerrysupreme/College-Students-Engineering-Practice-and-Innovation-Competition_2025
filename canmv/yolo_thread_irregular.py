...
def handle_category(category):
    ...
    if category == r_flag:
        ...
        pass
def ball_check(x,y):
    if(330<=x<=510 and 310<=y<=420):#球在爪子内
        return True
    return False
def detect(cs = 0,cl = 0):#cs只能取0或3，表红色和蓝色,cl表球真实色彩取0,1,2,3
    global precs,color,send_flag
    send_flag = 0
    p = {}
    q = {}
    m = {}
...
if __name__ == "__main__":
    ...
    if display_mode=="hdmi":
        ...
        display_size=[800,480]
    kmodel_path="/sdcard/app/best_AnchorBaseDet_can2_5_n_20250421144931.kmodel"
    kmodel_path2="/sdcard/app/best_AnchorBaseDet_can2_5_n_20250422195651.kmodel"#不规则
    #best_AnchorBaseDet_can2_5_n_20250321000750.kmodel
    #best_AnchorBaseDet_can2_5_n_20250421144931.kmodel
    ...
    pl.create()
    uart = hardware_init()
    yolo = YOLODetector(kmodel_path2,labels,model_input_size=[640,640],anchors=anchors,rgb888p_size=[1280,720],display_size=display_size,debug_mode=0)
