...
if __name__ == "__main__":
    ...
    kmodel_path2="/sdcard/app/chufaqv.kmodel" #不规则
    ...
    labels2=["红方安全区","黑球","黄球","蓝球","红球","黑方安全区"]
    # labels2=["红方","蓝方"]
    labels=["红方","蓝方"]
    ...
    pl.create()
    uart = hardware_init()
    yolo_start = YOLODetector(kmodel_path2,labels,model_input_size=[640,640],anchors=anchors,rgb888p_size=[1280,720],display_size=display_size,debug_mode=0)
    yolo_start.config_preprocess()
    yolo_main = YOLODetector(kmodel_path,labels2,model_input_size=[640,640],anchors=anchors,rgb888p_size=[1280,720],display_size=display_size,debug_mode=0)
