...
class YOLODetector(AIBase):
    def __init__(self,kmodel_path,labels,model_input_size=[640,640],anchors=[10.13,16,30,33,23,30,61,62,45,59,119,116,90,156,198,373,326],model_type="AnchorBaseDet",confidence_threshold=0.5,nms_threshold=0.2,nms_option=False,strides=[8,16,32],rgb888p_size=[1280,720],display_size=[1920,1080],debug_mode=0):
...
def handle_category(category):
    ...
    if category == r_flag:
        ...
        pass
def ball_check(x,y):
    if(330<=x<=510 and 370<=y<=480):#球在爪子内
        return True
    return False
...
if __name__ == "__main__":
    ...
    if display_mode=="hdmi":
        ...
        display_size=[800,480]
    kmodel_path="/sdcard/app/model_ball_4.kmodel"
