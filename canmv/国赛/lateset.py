...
def detect(cs = 0,cl = 0,start = 0):#cs只能取0或3，表红色和蓝色,cl表球真实色彩取0,1,2,3
    global precs,color,send_flag,comeback,STAR
    send_flag = 0
    p = {}
    q = {}
    m = {}
    ...
    if(start==1):
        ...
        return
    # 绘制检测框
    if det_boxes and comeback == 1 and STAR != 1:
        pl.osd_img.clear()
...
if __name__ == "__main__":
    ...
    if display_mode=="hdmi":
        ...
        display_size=[800,480]
    kmodel_path="/sdcard/app/model_ball.kmodel"  #d:\yolo\final\model_ball_2\新项目\model_ball.kmodel
    kmodel_path2="/sdcard/app/chufaqv2.kmodel" #出发区
    kmodel_path3 = "sdcard/app/irr1.kmodel"
    #kmodel_path3 = "sdcard/app/best_AnchorBaseDet_can2_5_n_20250424141042.kmodel" #不规则2
    #irr1.kmodel # wjy不规则模型
        ...
        while True:
            ...
            with ScopedTiming("total",1):
                ...
                if(start==1):
                    ...
                    if((mode == 1 or mode == 2) and comeback == 0):
