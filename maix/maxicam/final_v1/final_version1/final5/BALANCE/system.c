...
//速度控制PID参数
float Velocity_KP=9.5,Velocity_KI=5;
...
//Bluetooth remote control associated flag bit
//蓝牙遥控相关的标志位
...
void systemInit(void)
{
   ...
   // uart6_init(9600);
    ...
    //定时器12用作舵机的PWM接口
    TIM12_SERVO_Init(9999,84-1);  //APB1的时钟频率为84M , 频率=84M/((9999+1)*(83+1))=100Hz 0.01s
