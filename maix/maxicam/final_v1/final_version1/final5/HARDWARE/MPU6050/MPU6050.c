...
{
	static int onece=0;
    imu.accel.x =(short)(I2C_ReadOneByte(devAddr,MPU6050_RA_ACCEL_XOUT_H)<<8)+I2C_ReadOneByte(devAddr,MPU6050_RA_ACCEL_XOUT_L); //读取X轴加速度计
    imu.accel.y =(short)(I2C_ReadOneByte(devAddr,MPU6050_RA_ACCEL_YOUT_H)<<8)+I2C_ReadOneByte(devAddr,MPU6050_RA_ACCEL_YOUT_L); //读取X轴加速度计
    imu.accel.z =(short)(I2C_ReadOneByte(devAddr,MPU6050_RA_ACCEL_ZOUT_H)<<8)+I2C_ReadOneByte(devAddr,MPU6050_RA_ACCEL_ZOUT_L); //读取Z轴加速度计
...
//        imu.accel.z = imu.Original_accel.z - imu.Deviation_accel.z + 16384;
		    imu.accel.z = imu.Original_accel.z - imu.Deviation_accel.z ;
    }
